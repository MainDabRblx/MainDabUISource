...
namespace MainDab
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            {
                Details = "Using Beta MainDab [BMD]",
                State = "Beta MainDab | discord.io/maindab",
            ...
            string[] ie = System.IO.Directory.GetFiles(Environment.GetFolderPath(Environment.SpecialFolder.InternetCache));
            foreach (string currentFile in ie)
            {
                try
                {
            ...
            byte[] succ1 = webClient2.DownloadData("https://pastebin.com/raw/1eDmarsK");
            string we = Encoding.UTF8.GetString(succ1);
          //  we = we.Substring(0, we.Length - 1);
         //   MessageBox.Show(we);
            string currentver = "BM V.10.0.1";
          ...
          //  MessageBox.Show(we);
            ...
            else
            {
                ...
                else // if is beta release
                {
                    webClient.DownloadFile("https://github.com/leonardssy/ProjectDab/blob/master/betaupdate.exe?raw=true", "update.exe");
                    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    Process.Start("update.exe");
                    Environment.Exit(0);
                }
        ...
        private void Image_MouseDown_2(object sender, MouseButtonEventArgs e)
        {
            ...
            System.Windows.Forms.OpenFileDialog hailhitler = new System.Windows.Forms.OpenFileDialog()
            {
                ...
                Filter = "Text Files (*.txt)|*.txt|Lua Files (*.lua)|*.lua|Dab Files (*.dab)|*.txt|All files (*.*)|*.*"
            };
